...
class ContactController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      return back()->withSuccess("Thanks for contacting us $request->name , your feedback has been submitted successfully");
    }

    public function sendMail($data)
    {
        $recepient = ['hackshadetechs@gmail.com'];
        Mail::to($recepient)->send(new ContactNotification($data));
    }
